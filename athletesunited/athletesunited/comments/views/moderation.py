...
def flag(request, comment_id, next=None):
    ...
    if request.method == 'POST':
        ...
        return next_redirect(request, fallback=next or 'flag_done',
            c=comment.pk)
...
def delete(request, comment_id, next=None):
    ...
    if request.method == 'POST':
        ...
        return next_redirect(request, fallback=next or 'delete_done',
            c=comment.pk)
...
def approve(request, comment_id, next=None):
    ...
    if request.method == 'POST':
        ...
        return next_redirect(request, fallback=next or 'approve_done',
            c=comment.pk)
